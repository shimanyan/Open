...
この文献で導入されているSW-FV-SBLのモデルのsliding-windingブロックの長さの上限は論文と同じで300としている。
＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿
#endif

//g++ -Wall -std=c++11 -I/usr/local/include CASE1-SW-FV-SBL.cc
...
for (int i = 0; i < total_num; i++){
    ...
    fprintf(gp, "plot '-' with lines linestyle 6 linetype 6 linewidth 1 dt '_.-.' title \"SW-FV-SBL\"\n");
